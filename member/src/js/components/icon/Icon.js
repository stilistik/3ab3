...
import SortAlphaIcon from '@material-ui/icons/SortByAlpha';
import SortIcon from '@material-ui/icons/Sort';
import ShareIcon from '@material-ui/icons/Share';
import TiltShiftIcon from '@material-ui/icons/FilterTiltShift';
...
const Icon = (props) => {
  ...
  if (type in customIconTypes) {
    const CustomIcon = customIconTypes[type];
    return <CustomIcon {...rest} />;
  } else if (type in muiIconTypes) {
    const MuiIcon = muiIconTypes[type];
    return <MuiIcon {...rest} />;
  } else {
